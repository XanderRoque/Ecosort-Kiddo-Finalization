...
public class House_Game_Activity extends AppCompatActivity {
    ...
    private int[] tutorialImages = {
            R.drawable.house_story1,
            R.drawable.house_story2,
    ...
    private int[] tutorialFilipinoImages = {
            R.drawable.house_filipino_story1,
            R.drawable.house_filipino_story2,
    ...
    private int[] rewardImages = {
            R.drawable.house_earn1,
            R.drawable.house_earn2,
            R.drawable.house_earn3,
            R.drawable.house_story3,
            R.drawable.house_story4,
            R.drawable.house_story5,
            R.drawable.house_story6
    };
    ...
    private int[] rewardFilipinoImages = {
            R.drawable.house_filipino_earn1,
            R.drawable.house_filipino_earn2,
            R.drawable.house_filipino_earn3,
            R.drawable.house_filipino_story3,
            R.drawable.house_filipino_story4,
            R.drawable.house_filipino_story5,
            R.drawable.house_filipino_story6
    };
...
private void initializeDependencies() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_house_game);

        ConstraintLayout   layout = findViewById(R.id.activity_house_game); // Replace with your layout ID
...
//        startCountDownTimer(TIMER_DURATION);
        ...
        List<Garbage> garbageList = garbageDao.getGarbageByLocationIdAndLevelId(Location.HOME, Integer.valueOf(selectedLevel));
...
//        victory and failed message Filipino
        //ImageView filipino_victoryMessage= findViewById(R.drawable.filipino_complete);
...
//                    Toast.makeText(getApplicationContext(), "Trash disposed!", Toast.LENGTH_SHORT).show();
        ...
        tutorialFilipinoCardview = findViewById(R.id.house_Filipinotutorial);
        tutorialFilipinoCardview.setVisibility(View.GONE);

        rewardCardview = findViewById(R.id.earnReward_cardview);
        rewardCardview.setVisibility(View.GONE);

        rewardFilipinoCardview = findViewById(R.id.earnFilipinoReward_cardview);
        ...
        if(myProfile.getTutorialDoneLocation1() == 0){
            pauseTimer();
...
//        });
    ...
    private void translateText(String languageCode) {
        ...
        TextView textNextTutorial= findViewById(R.id.next_tutorial);
...
//    }
    ...
    private void setupTutorial() {
        ...
        TextView tutorialText = findViewById(R.id.next_tutorial);
        ...
        Profile myProfile = profileDao.getProfile(1);
        myProfile.setTutorialDoneLocation1(1);
        profileDao.updateProfile(myProfile);
    }

    private void setupFilipinoTutorial() {
        tutorialFilipinoCardview = findViewById(R.id.house_Filipinotutorial);
        tutorialFilipinoImageView = findViewById(R.id.house_Filipinotutorial1);
        TextView tutorialFilipinoText = findViewById(R.id.next_Filipinotutorial);
    ...
    private void earnRewardCardView() {
        rewardCardview = findViewById(R.id.earnReward_cardview);
        rewardImageView = findViewById(R.id.earnReward_view);
        TextView rewardText = findViewById(R.id.next_earnReward);
...
//                rewardCardview.setVisibility(View.GONE); // Hide the tutorial when the sequence is finished
                Intent intent = new Intent(House_Game_Activity.this, House_Location_Activity.class);
    ...
    private void earnFilipinoRewardCardView() {
        rewardFilipinoCardview = findViewById(R.id.earnFilipinoReward_cardview);
        rewardFilipinoImageView = findViewById(R.id.earnFilipinoReward_view);
        TextView rewardFilipinoText = findViewById(R.id.nextFilipino_earnReward);
...
//                rewardCardview.setVisibility(View.GONE); // Hide the tutorial when the sequence is finished
    ...
    private void changeBackground(int level, ConstraintLayout  layout) {
        ...
        if (level == 3) {
            layout.setBackgroundResource(R.drawable.house_sala_level); // Replace with your drawable
        } else if (level == 4) {
            layout.setBackgroundResource(R.drawable.house_sala_level); // Replace with your drawable
        }else if (level == 5) {
            layout.setBackgroundResource(R.drawable.house_kitchen_level); // Replace with your drawable
        }else if (level == 6) {
            layout.setBackgroundResource(R.drawable.house_kitchen_level); // Replace with your drawable
        }
    }
...
//    }
    ...
    private void setDragEnabled() {
        ...
        List<Garbage> garbageList = garbageDao.getGarbageByLocationIdAndLevelId(Location.HOME, selectedLevelInt);
        int ctr = 0;
        for (Garbage g : garbageList) {
            ctr++;
            Integer imageViewId = imageIdToNameMap.get(ctr);
    ...
    private void showBackInGameCardView() {
        ...
        backButton.setOnClickListener(v -> {
            Log.d("Debug", "showBackInGameCardView called");
            playButtonSound();
            toggleMusic(false);
            cardView.setVisibility(View.VISIBLE);
            pauseTimer();
    ...
    private void setNoInGameCardView() {
        Button buttonCvNo = findViewById(R.id.houseButton_no);
        if (buttonCvNo != null) {
    ...
    private void setYesInGameCardView() {
        Button buttonCvYes = findViewById(R.id.houseButton_yes);
        if (buttonCvYes != null) {
    ...
    private void setupWindowInsets() {
        View mainView = findViewById(R.id.activity_house_game);
...
//                if (Settings.LANGUAGE_ENGLISH.equalsIgnoreCase(settings.getLanguage())) {
//                    failedMessage.setImageResource(R.drawable.gameover); // English image
//                } else {
//                    failedMessage.setImageResource(R.drawable.filipino_gameover); // Tagalog image
//                }
//
//                failedMessage.invalidate();
            ...
            if (failedMessage != null) {
                failedMessage.setVisibility(View.GONE); // Ensure failedMessage is hidden
            }
            if (victoryMessage != null) {
...
//        }
        ...
        StarRating sr =  starRatingDao.getStarRatingByProfileIdLocationIdAndLevelId(1,Location.HOME, selectedLevel);
        if(sr == null){
            ...
            sr.setLocationId(Location.HOME);
        ...
        if (timeLeftInMillis <= 0) {
            if(starsCountInHomeLocation == StarRating.TOTAL_STARS_HOME){
                ...
                int isCompleted = profile.getIsLocationCompletedHouse();
                if(isCompleted == 0){
                    profile.setIsLocationCompletedHouse(1);
    ...
    private void setupPlayAgainButton() {
        Button playAgainButton = findViewById(R.id.btn_try);
        if (playAgainButton != null) {
            playAgainButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(House_Game_Activity.this, House_Game_Activity.class);
    ...
    private Button setupNextLevelButton() {
        Button nextButton = findViewById(R.id.btn_next); // Initialize the button
        if (nextButton != null) {
            nextButton.setOnClickListener(v -> {
                ...
                if (nextLevel <= 6) { // Assuming you have 6 levels
                    intent = new Intent(House_Game_Activity.this, House_Game_Activity.class);
