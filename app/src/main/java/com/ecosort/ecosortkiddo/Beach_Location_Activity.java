...
//                setButtonsEnabled(true);
    ...
    static {
        starRatingLevelingMapping.put(1, Integer.valueOf(R.id.location4_starRating_level1));
        starRatingLevelingMapping.put(2, Integer.valueOf(R.id.location4_starRating_level2));
        starRatingLevelingMapping.put(3, Integer.valueOf(R.id.location4_starRating_level3));
        starRatingLevelingMapping.put(4, Integer.valueOf(R.id.location4_starRating_level4));
        starRatingLevelingMapping.put(5, Integer.valueOf(R.id.location4_starRating_level5));
        starRatingLevelingMapping.put(6, Integer.valueOf(R.id.location4_starRating_level6));
    }
